...
**Azw file conversion no longer works with the latest Kdl (you have to use a version earlier than 2.2.0). Read more [here](https://github.com/ToofDerling/CbzMage/discussions/35)**
...
**All of this works fully in [CbzMage Version 1.0](https://github.com/ToofDerling/CbzMage/releases/tag/v1.0).**
...
* **Ghostscript 10 on Linux.** The only distro I know of that has upgraded to Ghostscript version 10 is [Arch Linux](https://archlinux.org/). I tried a handful of the popular ones and they were all at version 9, which doesn't work with CbzMage. 
