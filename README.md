...
**Azw file conversion doesn't work with the latest Kdl. You have to use a version earlier than 2.2.0, read more [here](https://github.com/ToofDerling/CbzMage/discussions/35)**
